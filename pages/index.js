...
export default function Home() {
  return (
    <div className="w-full flex justify-center items-center text-center bg-white">
      <main className="flex flex-col items-center justify-center min-h-screen py-10 px-4 max-w-7xl mx-auto">
        {/* Hero 区域 */}
