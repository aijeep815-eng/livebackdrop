      ...
      <div className="max-w-7xl mx-auto px-6" style={barStyle}>
        ...
        >
          ...
          <div style={dropdownStyle(openTools)}>
            <Link href="/generate" className={linkCls}>
              Generate Background
            </Link>
        ...
        <Link href="/pricing" className={topLinkCls}>
          Pricing
        </Link>
        <Link href="/gallery" className={topLinkCls}>
          Gallery
        </Link>
        <Link href="/about" className={topLinkCls}>
          About
        </Link>
        <Link href="/contact" className={topLinkCls}>
          Contact
        </Link>
      </div>
    </nav>
